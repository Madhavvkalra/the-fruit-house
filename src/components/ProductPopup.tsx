...
return (
  <div
    className={`
      ...
      ${
        isProductPopupClosing
          ? 'animate-[productPopupExit_.55s_cubic-bezier(.7,0,.84,0)_forwards]'
          : 'animate-[productPopupEnter_.75s_cubic-bezier(.16,1,.3,1)_forwards]'
      }
  ...
  >
      ...
      <div
        className="relative flex h-full w-full flex-col overflow-y-auto bg-[#f5f3e8] text-[#17351d] shadow-[0_30px_100px_rgba(0,0,0,.28)] animate-[productPopupEnter_.85s_cubic-bezier(.16,1,.3,1)] sm:h-auto sm:max-h-[94vh] sm:overflow-hidden sm:max-w-[900px] sm:rounded-[30px] md:flex-row"
        onClick={(event) => event.stopPropagation()}
      >
...
>
  ×
        ...
        <div className="relative shrink-0 bg-[#e9eadb] sm:h-[420px] md:h-auto md:w-[48%]">
          ...
          <div
           className="relative h-[42svh] min-h-[300px] max-h-[460px] shrink-0 overflow-hidden touch-pan-y sm:h-[420px] sm:rounded-t-[30px] md:h-full md:min-h-[650px] md:rounded-none"
  ...
  : 'transform 700ms cubic-bezier(0.16, 1, 0.3, 1)',
        ...
        >
          ...
          <div
            className={`px-6 pb-10 pt-7 transition-all duration-300 sm:px-8 sm:pb-10 sm:pt-9 md:px-10 md:py-10 ${
              isProductChanging
          ...
          >
            ...
            {selectedPopupVariant && (
              (() => {
                ...
                if (popupQuantity <= 0) {
                  return (
                    <button
                      ...
                      className="mt-7 flex h-[56px] w-full items-center justify-center gap-3 rounded-[18px] bg-[#0d4b36] px-6 text-[15px] font-semibold text-white shadow-[0_12px_30px_rgba(13,75,54,.18)] transition hover:bg-[#17351d] active:scale-[0.98]"
                    >
                ...
                return (
                  <div
                    className="mt-7 flex h-[56px] w-full items-center justify-between rounded-[18px] bg-[#0d4b36] px-4 text-white shadow-[0_12px_30px_rgba(13,75,54,.18)]"
                    onClick={(event) => {
                      event.stopPropagation()
                    }}
                  >
                    ...
                    <button
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-full text-xl transition hover:bg-white/10 active:scale-90"
                    >
                      −
                    </button>
