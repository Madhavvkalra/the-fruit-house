...
export default function RecipientLocation({
  ...
  const reverseGeocode = async (
    ...
    // Immediately show coordinates while lookup happens.
    setLocation(
              ...
              <div className="mt-5">
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                  ...
                  <button
                    ...
                    className="flex h-12 items-center justify-center gap-2 rounded-[14px] border border-[#17351d]/15 bg-[#efffb0] px-4 text-sm font-semibold text-[#17351d] transition hover:bg-[#e6f59d] active:scale-[0.98] disabled:cursor-wait disabled:opacity-60"
                  >
                  ...
                  <button
                    ...
                    className="flex h-12 items-center justify-center gap-2 rounded-[14px] border border-[#17351d]/15 bg-white px-4 text-sm font-semibold text-[#17351d] transition hover:bg-[#faf8ef] active:scale-[0.98]"
                  >
                    <span className="text-base">
                      🗺️
                    </span>
                    ...
                    <div className="mt-4 overflow-hidden rounded-[20px] border border-[#17351d]/10 bg-[#faf8ef] shadow-[0_10px_35px_rgba(8,21,11,.05)]">
                      ...
                      <div className="px-4 py-4">
                        ...
                        <button
                          ...
                          className="mt-3 inline-flex h-9 items-center rounded-full border border-[#17351d]/15 bg-white px-4 text-xs font-semibold text-[#17351d] shadow-sm transition hover:border-[#17351d]/30 hover:bg-[#17351d] hover:text-white active:scale-[0.97]"
                        >
                          Change location
                        </button>
